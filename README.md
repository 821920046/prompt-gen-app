...
- 🔗 **视频链接解析**: 粘贴抖音/TikTok/B站/快手/小红书链接，自动解析生成提示词
- 🎬 **视频上传**: 上传视频文件，AI分析并生成提示词
...
|------|---------|------|
| 抖音 | v.douyin.com | ✅ 支持 |
| TikTok | tiktok.com | ✅ 支持 |
| 哔哩哔哩 | bilibili.com, b23.tv | ✅ 支持 |
| 快手 | kuaishou.com | 🚧 开发中 |
| 小红书 | xiaohongshu.com | 🚧 开发中 |
| 微博 | weibo.com | 🚧 开发中 |
...
│   ├── services/
│   │   ├── promptGenerator.ts # 提示词生成引擎
│   │   └── videoUrlParser.ts  # 视频链接解析
│   ├── models/               # 类型定义和模板
│   └── utils/                # 存储工具
├── public/
│   ├── index.html            # 前端页面
